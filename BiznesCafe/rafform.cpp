...
using namespace std;
RafForm::RafForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::RafForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &RafForm::on_pushButton_clicked);
    installEventFilter(this);}

void RafForm::showEvent(QShowEvent *event)
{
...
void RafForm::on_Buttpl_clicked()
{
...
void RafForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void RafForm::on_pushButton_clicked()
{
