...
using namespace std;
PeanutsForm::PeanutsForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::PeanutsForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &PeanutsForm::on_pushButton_clicked);
    installEventFilter(this);}

void PeanutsForm::showEvent(QShowEvent *event)
{
    QWidget::showEvent(event);
    func(); // Call func() when the widget is shown
}

PeanutsForm::~PeanutsForm()
{
    ui->numberqwert->setText(QString::number(0));
    delete ui;
}
void PeanutsForm::func()
{
...
void PeanutsForm::on_Buttpl_clicked()
{
...
void PeanutsForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void PeanutsForm::on_pushButton_clicked()
{
...
void PeanutsForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
