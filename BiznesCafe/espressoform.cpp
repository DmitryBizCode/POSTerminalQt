...
using namespace std;
EspressoForm::EspressoForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::EspressoForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &EspressoForm::on_pushButton_clicked);
    installEventFilter(this);}

void EspressoForm::showEvent(QShowEvent *event)
{
...
void EspressoForm::on_Buttpl_clicked()
{
...
void EspressoForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void EspressoForm::on_pushButton_clicked()
{
...
void EspressoForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
