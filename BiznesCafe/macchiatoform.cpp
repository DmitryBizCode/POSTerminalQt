...
using namespace std;
MacchiatoForm::MacchiatoForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::MacchiatoForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &MacchiatoForm::on_pushButton_clicked);
    installEventFilter(this);
}
void MacchiatoForm::showEvent(QShowEvent *event)
{
    QWidget::showEvent(event);
    func(); // Call func() when the widget is shown
}

MacchiatoForm::~MacchiatoForm()
{
    ui->numberqwert->setText(QString::number(0));
    delete ui;
}
void MacchiatoForm::func()
{
...
void MacchiatoForm::on_Buttpl_clicked()
{
...
void MacchiatoForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void MacchiatoForm::on_pushButton_clicked()
{
...
void MacchiatoForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
