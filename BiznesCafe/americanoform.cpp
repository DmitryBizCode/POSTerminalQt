...
using namespace std;
AmericanoForm::AmericanoForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::AmericanoForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &AmericanoForm::on_pushButton_clicked);
    installEventFilter(this);}

void AmericanoForm::showEvent(QShowEvent *event)
{
    QWidget::showEvent(event);
    func(); // Call func() when the widget is shown
}

AmericanoForm::~AmericanoForm()
{
    ui->numberqwert->setText(QString::number(0));
    delete ui;
}
void AmericanoForm::func()
{
...
void AmericanoForm::on_Buttpl_clicked()
{
...
void AmericanoForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void AmericanoForm::on_pushButton_clicked()
{
...
void AmericanoForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
