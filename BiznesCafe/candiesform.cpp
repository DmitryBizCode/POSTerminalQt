...
using namespace std;
CandiesForm::CandiesForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::CandiesForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &CandiesForm::on_pushButton_clicked);
    installEventFilter(this);}

void CandiesForm::showEvent(QShowEvent *event)
{
    QWidget::showEvent(event);
    func(); // Call func() when the widget is shown
}

CandiesForm::~CandiesForm()
{
    ui->numberqwert->setText(QString::number(0));
    delete ui;
}
void CandiesForm::func()
{
...
void CandiesForm::on_Buttpl_clicked()
{
...
void CandiesForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void CandiesForm::on_pushButton_clicked()
{
...
void CandiesForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
