...
using namespace std;
CappuccinoForm::CappuccinoForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::CappuccinoForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &CappuccinoForm::on_pushButton_clicked);
    installEventFilter(this);}

void CappuccinoForm::showEvent(QShowEvent *event)
{
    QWidget::showEvent(event);
    func(); // Call func() when the widget is shown
}

CappuccinoForm::~CappuccinoForm()
{
    ui->numberqwert->setText(QString::number(0));
    delete ui;
}
void CappuccinoForm::func()
{
...
void CappuccinoForm::on_Buttpl_clicked()
{
...
void CappuccinoForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void CappuccinoForm::on_pushButton_clicked()
{
...
void CappuccinoForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
