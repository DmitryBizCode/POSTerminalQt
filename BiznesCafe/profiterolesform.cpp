...
using namespace std;
ProfiterolesForm::ProfiterolesForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ProfiterolesForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &ProfiterolesForm::on_pushButton_clicked);
    installEventFilter(this);}

void ProfiterolesForm::showEvent(QShowEvent *event)
{
    QWidget::showEvent(event);
    func(); // Call func() when the widget is shown
}

ProfiterolesForm::~ProfiterolesForm()
{
    ui->numberqwert->setText(QString::number(0));
    delete ui;
}
void ProfiterolesForm::func()
{
...
void ProfiterolesForm::on_Buttpl_clicked()
{
...
void ProfiterolesForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void ProfiterolesForm::on_pushButton_clicked()
{
...
void ProfiterolesForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
