...
using namespace std;
QuicheForm::QuicheForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::QuicheForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &QuicheForm::on_pushButton_clicked);
    installEventFilter(this);}

void QuicheForm::showEvent(QShowEvent *event)
{
...
void QuicheForm::on_Buttpl_clicked()
{
...
void QuicheForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void QuicheForm::on_pushButton_clicked()
{
...
void QuicheForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
