...
using namespace std;
CroissantForm::CroissantForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::CroissantForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &CroissantForm::on_pushButton_clicked);
    installEventFilter(this);}

void CroissantForm::showEvent(QShowEvent *event)
{
    QWidget::showEvent(event);
    func(); // Call func() when the widget is shown
}

CroissantForm::~CroissantForm()
{
    ui->numberqwert->setText(QString::number(0));
    delete ui;
}
void CroissantForm::func()
{
...
void CroissantForm::on_Buttpl_clicked()
{
...
void CroissantForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void CroissantForm::on_pushButton_clicked()
{
...
void CroissantForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
