...
using namespace std;
FlatWhForm::FlatWhForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::FlatWhForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &FlatWhForm::on_pushButton_clicked);
    installEventFilter(this);}

void FlatWhForm::showEvent(QShowEvent *event)
{
    QWidget::showEvent(event);
    func(); // Call func() when the widget is shown
}

FlatWhForm::~FlatWhForm()
{
    ui->numberqwert->setText(QString::number(0));
    delete ui;
}
void FlatWhForm::func()
{
...
void FlatWhForm::on_Buttpl_clicked()
{
...
void FlatWhForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void FlatWhForm::on_pushButton_clicked()
{
...
void FlatWhForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
