...
using namespace std;
Tea_blackForm::Tea_blackForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Tea_blackForm)
{
    ui->setupUi(this);
    connect(ui->pushButton, &QPushButton::clicked, this, &Tea_blackForm::on_pushButton_clicked);
    installEventFilter(this);}

void Tea_blackForm::showEvent(QShowEvent *event)
{
    QWidget::showEvent(event);
    func(); // Call func() when the widget is shown
}

Tea_blackForm::~Tea_blackForm()
{
    ui->numberqwert->setText(QString::number(0));
    delete ui;
}
void Tea_blackForm::func()
{
...
void Tea_blackForm::on_Buttpl_clicked()
{
...
void Tea_blackForm::on_Buttmin_clicked()
{
    int* itemPrice = new int(ui->numberqwert->text().toInt());
    (*itemPrice)--;
    if (*itemPrice >= 0)
...
void Tea_blackForm::on_pushButton_clicked()
{
...
void Tea_blackForm::on_Zerno_clicked()
{
    ui->numberqwert->setText(QString::number(0));
    // Check if a MainWindow instance already exists
    QList<QWidget*> topLevelWidgets = QApplication::topLevelWidgets();
